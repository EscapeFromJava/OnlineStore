...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 16 2022 г., 00:12
...
--
CREATE DATABASE IF NOT EXISTS `gadjet_market` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `gadjet_market`;
...
CREATE TABLE `products` (
  ...
  `SPECIFICATIONS` text DEFAULT NULL COMMENT 'Характеристики ',
