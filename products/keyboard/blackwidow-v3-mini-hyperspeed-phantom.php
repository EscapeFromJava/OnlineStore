...
<body>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <a href="/img/blackwidow-v3-mini-hyperspeed-phantom.jpg" target="_blank"><img src="/img/blackwidow-v3-mini-hyperspeed-phantom.jpg" alt="RAZER BLACKWIDOW V3 MINI HYPERSPEED - PHANTOM EDITION"></a>

      <p>СВОБОДА В ФОРМЕ</p>
      <p class=" short_desc">
        Достаточно компактная для любого окружения и достаточно универсальная для любых настроек - это Razer BlackWidow
